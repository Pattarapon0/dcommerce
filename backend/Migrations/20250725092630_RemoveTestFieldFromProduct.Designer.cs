...
namespace backend.Migrations
{
    ...
    [Migration("20250725092630_RemoveTestFieldFromProduct")]
    partial class RemoveTestFieldFromProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 7, 25, 9, 26, 30, 434, DateTimeKind.Utc).AddTicks(8709));
