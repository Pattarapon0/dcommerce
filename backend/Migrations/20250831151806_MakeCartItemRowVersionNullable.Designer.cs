...
namespace backend.Migrations
{
    ...
    [Migration("20250831151806_MakeCartItemRowVersionNullable")]
    partial class MakeCartItemRowVersionNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 31, 15, 18, 5, 907, DateTimeKind.Utc).AddTicks(2662));
