...
namespace backend.Migrations
{
    ...
    [Migration("20250817112232_AddSellerApprovalFields")]
    partial class AddSellerApprovalFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 8, 17, 11, 22, 31, 787, DateTimeKind.Utc).AddTicks(2880));
