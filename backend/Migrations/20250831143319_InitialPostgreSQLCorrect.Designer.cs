...
namespace backend.Migrations
{
    ...
    [Migration("20250831143319_InitialPostgreSQLCorrect")]
    partial class InitialPostgreSQLCorrect
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 31, 14, 33, 18, 938, DateTimeKind.Utc).AddTicks(8800));
