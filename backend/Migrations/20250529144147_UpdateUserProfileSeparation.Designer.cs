...
namespace server.Migrations
{
    ...
    [Migration("20250529144147_UpdateUserProfileSeparation")]
    partial class UpdateUserProfileSeparation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("server.Data.User.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("ProfileComplete")
                        ...
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false)
                        .HasComment("Whether user has completed their profile setup");

                    b.Property<DateTime?>("ProfileCompletedAt")
                        .HasColumnType("TEXT")
                        .HasComment("Timestamp when profile was completed");
            ...
            modelBuilder.Entity("server.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 5, 29, 14, 41, 47, 370, DateTimeKind.Utc).AddTicks(5017));
