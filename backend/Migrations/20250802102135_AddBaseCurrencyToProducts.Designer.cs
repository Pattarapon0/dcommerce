...
namespace backend.Migrations
{
    ...
    [Migration("20250802102135_AddBaseCurrencyToProducts")]
    partial class AddBaseCurrencyToProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 8, 2, 10, 21, 34, 543, DateTimeKind.Utc).AddTicks(5519));
