...
namespace backend.Migrations
{
    ...
    [Migration("20250725092505_AddTestFieldToProduct")]
    partial class AddTestFieldToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 7, 25, 9, 25, 4, 501, DateTimeKind.Utc).AddTicks(8249));
