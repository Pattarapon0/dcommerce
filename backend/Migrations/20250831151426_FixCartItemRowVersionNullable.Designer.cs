...
namespace backend.Migrations
{
    ...
    [Migration("20250831151426_FixCartItemRowVersionNullable")]
    partial class FixCartItemRowVersionNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 8, 31, 15, 14, 25, 762, DateTimeKind.Utc).AddTicks(4622));
