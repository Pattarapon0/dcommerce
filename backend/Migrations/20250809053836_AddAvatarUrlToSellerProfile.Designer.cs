...
namespace backend.Migrations
{
    ...
    [Migration("20250809053836_AddAvatarUrlToSellerProfile")]
    partial class AddAvatarUrlToSellerProfile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Data.User.Entities.UserLogin", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2025, 8, 9, 5, 38, 35, 999, DateTimeKind.Utc).AddTicks(9954));
