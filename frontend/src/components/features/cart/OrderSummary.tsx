    ...
    <div className="bg-white rounded-xl border p-6 space-y-4">
      ...
      <div className="space-y-2 text-sm">
        <div className="flex justify-between">
          ...
          <span className="tabular-nums">{formatCartPrice(subtotal, currency)}</span>
        </div>
        
        <div className="flex justify-between">
          <span>Shipping</span>
          <span className="tabular-nums text-green-600">
            {shipping === 0 ? 'FREE' : formatCartPrice(shipping, currency)}
          </span>
        </div>
        
        <div className="flex justify-between">
          <span>Tax</span>
          <span className="tabular-nums">{formatCartPrice(tax, currency)}</span>
        </div>
      </div>
      ...
      <div className="border-t pt-4">
        <div className="flex justify-between text-lg font-bold">
          <span>Total</span>
          <span className="tabular-nums">{formatCartPrice(total, currency)}</span>
        </div>
      </div>
